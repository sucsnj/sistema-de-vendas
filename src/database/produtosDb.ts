...
export const getServicos = (options: {
  ...
  const services = db.prepare(servicesQuery).all(...params, pageSize, offset) as any[];
...
export const toggleServicoStatus = (id: number, _ativo?: number) => {
  return db.prepare(`
    UPDATE servicos
